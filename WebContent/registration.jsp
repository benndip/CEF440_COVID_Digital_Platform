...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					<a href="index.html" class="logo"><strong> Internet Programming Project</strong></a>
					<nav id="nav">
						<a href="index.html">Home</a>
						<a href="dgiOneView.html">User</a>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<header>
						<h1>Welcome to Covid Assistance</h1>
					</header>
					...
					<div class="flex ">
						...
						<div>
							<h3>Address</h3>
							<p>SouthWest, UB Campus, TT Nagar<br> Bhopal, Madhya Pradesh 462003</p>
						</div>
 ...
 <hr class="new1">
<center><h1>Registration Team</h1></center> 
	</body>
</html>